...
export async function fetchFundamentals(symbol: string): Promise<Fundamentals> {
    ...
    return {
        ...
        eps: data.eps ?? null,
        roe: data.roe != null ? data.roe / 100 : null,
        de_ratio: data.de_ratio ?? null,
        quick_ratio: data.quick_ratio ?? null,
        ...
        operating_margin: data.operating_margin != null ? data.operating_margin / 100 : null,
        net_margin: data.net_margin != null ? data.net_margin / 100 : null,
        div_yield: data.div_yield != null ? data.div_yield / 100 : null,
        beta: data.beta ?? null,
        high_52w: data.high_52w ?? null,
        low_52w: data.low_52w ?? null,
    };
}
